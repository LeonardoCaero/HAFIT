export const environment = {
  production: false,
  apiUrl: 'https://hafit-restapi-dwix.onrender.com/api/',//'http://localhost:8000/api/',
  defaultImage:
  ...
  auth_domain: 'dev-jwr2u354q8g4qn7i.us.auth0.com',
  auth_clientId: 'KvYM7uivBTAza66zaPJPmtBUz0kpoUCw',
};
